...
Under the **Settings** tab, scroll down and select **Pages** from the sidebar menu. This action will open the **GitHub Pages** settings window, where you can configure the options for publishing your website. In this section, you will be able to choose the source for your site, such as the branch and folder where your website files are stored, and customize other settings related to your GitHub Pages site. T


![](github_pages.png)

In the **GitHub Pages** settings, locate the dropdown menu under the **Branch** section. Click on the drop-down arrow, and select **main** as the branch from which your site will be built. This tells GitHub Pages to use the content from the `main` branch of your repository to generate and host your website. 
